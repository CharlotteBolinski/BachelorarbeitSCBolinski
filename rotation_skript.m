...
[Random_werte x y z] = transformation_export(Random_werte, x, y, z,[1 0 0], 30, [0 1 0],[0 0 0], 'rotation.csv')
[Random_werte2 x2 y2 z2] = transformation_export(Random_werte2, x2, y2, z2,[0 1 0], -30, [0 1 0],[0 0 0], 'rotation.csv')
...
%Projektion
projektion = Data3D_Projektion('rotation_projektion.csv','rotation.csv', 1, 1, [2 2]);
