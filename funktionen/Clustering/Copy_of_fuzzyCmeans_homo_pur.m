function [ cluster1, cluster2, cluster_zentrum, p] = fuzzyCmeans_homo_pur( input, vektoren, numCluster )
    ...
    m = 2.4; %fuzzy Parameter/ Gewichtung.. fuzzyness Parameter, Standard 2
