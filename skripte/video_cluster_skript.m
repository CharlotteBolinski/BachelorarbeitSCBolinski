...
[fuzzy_cluster_homo1, fuzzy_cluster_homo2, homographie_fehler_index, homographie_daten] = fuzzyCmeans_homo_mad_norm(cluster_input, vektor_input, 2);
...
unterschiedPlot(cluster1_wahr, cluster2_wahr, video_cluster1, video_cluster2, fuzzy_clusterZentrum1frame, 'Clustering Ergebnis Video Sequenz!');
