...
%Linearinterpolation
[Random_werte_A x y z] = transformation_export(Random_werte_A, x, y, z,[1 0 0], 0, [0 1 0],[0 0 5], 'tiefe_A.csv')
[Random_werte_B x2 y2 z2] = transformation_export(Random_werte_B, x2, y2, z2,[0 1 0], 0, [1 0 0],[0 0 -5], 'tiefe_B.csv')

%Projektion
projektion_A = Data3D_Projektion('tiefe_A.csv', 1, 1, [2 2]);
projektion_B = Data3D_Projektion('tiefe_B.csv', 1, 1, [2 2]);
